...
class RealisasiPD extends BaseController
{
    ...
    public function parafTrainer($id)
    {
        ...
        return redirect()->to('/ListPengetahuanDasar/DetailsUserPengetahuanDasar/' . $id)->with('pesan', 'Berhasil Menyetujui Trainee OPL Pengetahuan Dasar');
    }
    ...
    public function deleteTrainee($id)
    {
        ...
        return redirect()->to('/ListPengetahuanDasar/DetailsUserPengetahuanDasar/' . $id)->with('pesan', 'Berhasil Membatalkan Trainee OPL Pengetahuan Dasar');
    }
}
