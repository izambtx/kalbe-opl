...
class RealisasiTS extends BaseController
{
    ...
    public function parafTrainer($id)
    {
        ...
        return redirect()->to('/ListTroubleShooting/DetailsUserTroubleShooting/' . $id)->with('pesan', 'Berhasil Menyetujui Trainee OPL Trouble Shooting');
    }
    ...
    public function deleteTrainee($id)
    {
        ...
        return redirect()->to('/ListTroubleShooting/DetailsUserTroubleShooting/' . $id)->with('pesan', 'Berhasil Membatalkan Trainee OPL Pengetahuan Dasar');
    }
}
