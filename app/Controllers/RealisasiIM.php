...
class RealisasiIM extends BaseController
{
    ...
    public function parafTrainer($id)
    {
        ...
        return redirect()->to('/ListImprovement/DetailsUserImprovement/' . $id)->with('pesan', 'Berhasil Menyetujui Trainer OPL Improvement');
    }
    ...
    public function deleteTrainee($id)
    {
        ...
        return redirect()->to('/ListImprovement/DetailsUserImprovement/' . $id)->with('pesan', 'Berhasil Membatalkan Trainer OPL Pengetahuan Dasar');
    }
}
