...
<body id="page-top" onload="autoClick();">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion shadow" style="background-color: #393b42; z-index: 1;" id="accordionSidebar">
            <div class="sticky-top">
                ...
                <a class="nav-link text-center text-white" href="<?= base_url('/view_profile'); ?>" role="button">
                    <p class="mr-2 d-none d-lg-inline text-white font-weight-bold" style="font-size:1rem;;"><?= user()->fullname; ?></p>
                    <i class="fas fa-cog"></i>
                </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-dark py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item text-gray-400" href="<?= base_url('PengetahuanDasar'); ?>">Pengetahuan Dasar</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('Improvement'); ?>">Improvement</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('TroubleShooting'); ?>">Trouble Shooting</a>
                            </div>
                        </div>
                    </li>
                <?php endif; ?>
                ...
                <?php if (in_groups('supervisor') || in_groups('engineer')) : ?>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-dark py-2 collapse-inner rounded">
                                <h6 class="collapse-header text-gray-200">Kategori :</h6>
                                <a class="collapse-item text-gray-400" href="<?= base_url('/PengetahuanDasar/History'); ?>">Pengetahuan Dasar</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('/Improvement/History'); ?>">Improvement</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('/TroubleShooting/History'); ?>">Trouble Shooting</a>
                            </div>
                        </div>
                    </li>
                <?php elseif (in_groups('user')) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                            ...
                            <span>Sosialisasi OPL
                                <!-- <span class="badge badge-merah badge-counter"><?= $countRIM + $countRPD + $countRTS; ?></span> -->
                            </span>
                        </a>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-dark py-2 collapse-inner rounded">
                    ...
                    <!-- Nav Item - History Realisasi OPL Menu -->
                    <!-- <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                            <i class="fas fa-history"></i>
                            <span>History Sosialisasi</span>
                        </a>
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                            <div class="bg-dark py-2 collapse-inner rounded">
                                <h6 class="collapse-header text-gray-200">Kategori :</h6>
                                <a class="collapse-item text-gray-400" href="<?= base_url('List-Sosialisasi-PengetahuanDasar/History/' . user_id()); ?>">Pengetahuan Dasar</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('List-Sosialisasi-Improvement/History/' . user_id()); ?>">Improvement</a>
                                <a class="collapse-item text-gray-400" href="<?= base_url('List-Sosialisasi-TroubleShooting/History/' . user_id()); ?>">Trouble Shooting</a>
                            </div>
                        </div>
                    </li> -->
                <?php endif; ?>
                ...
                <!-- Nav Item - LOGOUT -->
                <li class="nav-item">
                    <a class="nav-link" data-toggle="modal" data-target="#logoutModal" style="background-color: #9c2727;" href="">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                            ...
                            <?php if (!empty($countRIM + $countRPD + $countRTS)) : ?>
                                ...
                                <?php elseif (in_groups('supervisor')) : ?>
                                    <?php if ($countRPD > '0') : ?>
                                        <a class="dropdown-item d-flex align-items-center" href="/PengetahuanDasar">
                                            <div class="mr-3">
                                                <div class="icon-circle bg-secondary">
                                                    <i class="fas fa-file-alt text-white"></i>
                                                </div>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($countRIM > '0') : ?>
                                        <a class="dropdown-item d-flex align-items-center" href="/Improvement">
                                            <div class="mr-3">
                                                <div class="icon-circle bg-secondary">
                                                    <i class="fas fa-file-alt text-white"></i>
                                                </div>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($countRTS > '0') : ?>
                                        <a class="dropdown-item d-flex align-items-center" href="/TroubleShooting">
                                            <div class="mr-3">
                                                <div class="icon-circle bg-secondary">
                                                    <i class="fas fa-file-alt text-white"></i>
                                                </div>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if (!empty($totalJumlahSOPL)) : ?>
                                    <?php if (in_groups('user')) : ?>
                                        <!-- Counter - Messages -->
                                        <span class="badge badge-merah badge-counter"><?= $totalJumlahSOPL; ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </a>
                            <?php if (in_groups('user')) : ?>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        ...
                        <span class="d-flex justify-content-end">V1.2</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
