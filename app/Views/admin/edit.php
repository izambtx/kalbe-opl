                            ...
                            <div class="px-5 pt-5 pb-3 my-4">
                                ...
                                <form class="user" action="<?= site_url('admin/' . $user->id) ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" disabled readonly class="form-control bg-light form-control-user <?php if (session('errors.fullname')) : ?>is-invalid<?php endif ?>" name="fullname" placeholder="Fullname" value="<?= $user->fullname; ?>" autofocus>
                                    </div>
                                    <div class="form-group row-password">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" disabled readonly class="form-control bg-light form-control-user <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" name="username" placeholder="Aliases" value="<?= $user->username; ?>">
                                            <div class="invalid-feedback">
                                                Please choose a username.
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="number" disabled readonly class="form-control bg-light form-control-user <?php if (session('errors.NIK')) : ?>is-invalid<?php endif ?>" name="NIK" placeholder="NIK" value="<?= $user->NIK; ?>">
                                            <div class="invalid-feedback">
                                                Please choose a NIK.
                                            </div>
                                        </div>
