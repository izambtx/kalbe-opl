                                ...
                                <form class="user" action="<?= url_to('login') ?>" method="post">
                                    ...
                                    <?php if ($config->validFields === ['email']) : ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control bg-light form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.email') ?>">
                                    ...
                                    <?php else : ?>
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control bg-light rounded-right border-left-0 form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.emailOrUsername') ?>" aria-label="login" aria-describedby="basic-addon1">
                                            <div class="invalid-feedback">
                                                <?= session('errors.login') ?>
                                            </div>
                                        </div>
