        ...
        <div class="row">
            ...
            <div class="card text-center shadow mx-auto table-responsive">
                    ...
                    <table class="table table-bordered text-gray-900">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if ($pengetahuandasarUser['status'] == 'Created' || $pengetahuandasarUser['status'] == 'Updated' || $pengetahuandasarUser['status'] == 'Returned Supervisor') : ?>
                ...
                <div class="container">
                    ...
                    <?php if ($pengetahuandasarUser['realisasi'] != 'FALSE' && $pengetahuandasarUser['pembuat'] == user_id()) : ?>
                        ...
                        <div class="col-auto d-flex mb-5">
                            ...
                            <?php if ($pengetahuandasarUser['realisasi'] == 'TRUE') : ?>
                                <div class="col-auto">
                                    <form action="/ListPengetahuanDasar/DetailsUserPengetahuanDasar/CloseSosialisasi/<?= $pengetahuandasarUser['id']; ?>" method="post">
                                        <?= csrf_field(); ?>
                            ...
                            <?php elseif ($pengetahuandasarUser['realisasi'] == 'CLOSED') : ?>
                                <div class="col-auto">
                                    <form action="/ListPengetahuanDasar/DetailsUserPengetahuanDasar/OpenSosialisasi/<?= $pengetahuandasarUser['id']; ?>" method="post">
                                        <?= csrf_field(); ?>
                    ...
                    <div class="row p-3">
                        <table class="table table-hover table-bordered text-gray-900">
                            <tbody>
                                ...
                                <?php $i = 1 + ($perPage * ($currentPage - 1)); ?>
                                <?php foreach ($realisasiPD as $rpd)
                                    foreach ($realisasiTrainerPD as $rpdt) : ?>
                                    <tr>
                                        <td class="align-middle" scope="row"><?= $i++; ?></td>
                                        <td class="align-middle" scope="row"><?= date('d M Y', strtotime($rpd['tanggal_training'])); ?></td>
                                        <td class="align-middle" scope="row"><?= $rpd['username']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rpd['paraf_trainee']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rpdt['username']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rpd['paraf_trainer']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr>
