                    ...
                    <table class="table table-bordered text-gray-900">
                        <tbody>
                            <tr>
                                ...
                                <td scope=" col" class=" align-middle"><small class="font-weight-bold" style="width: 10%;"><?= $pengetahuandasarUser['nama_mesin']; ?></small></td>
                            </tr>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td scope="col" class="align-middle border-left-0">
                                        <?php if ($pengetahuandasarUser['status'] == 'Returned Supervisor' || $pengetahuandasarUser['status'] == 'Returned Engineer') : ?>
                                            <a href="/ListPengetahuanDasar/Edit/DetailsUserPengetahuanDasar/<?= $pengetahuandasarUser['id']; ?>" class="btn btn-warning font-weight-bold">UPDATE</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            </tfoot>
