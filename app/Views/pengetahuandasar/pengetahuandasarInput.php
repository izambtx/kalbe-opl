...
<div class="container-fluid">
    ...
    <div class="card p-5">
        ...
        <div class="d-flex justify-content-between">
            <a href="<?= base_url('ListPengetahuanDasar/' . user()->id); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Back to List</a>
            ...
            <div class="form-group row">
                <div class="form-row col-sm-12 px-0">
                    ...
                    <div class="form-group col-sm-5">
                        <input type="number" min="0" max="15" class="form-control rounded-sm <?= ($validation->hasError('jumlahFoto')) ? 'is-invalid' : ''; ?>" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $inputFotoPD; ?>">
                    </div>
        ...
        <!-- Form Input -->
        <form action="/ListPengetahuanDasar/SavePengetahuanDasar" method="post" enctype="multipart/form-data">
            <?php csrf_field(); ?>

            <?php $jumlahFoto = $inputFotoPD ?>
            <?php for ($i = 1; $i <= $jumlahFoto; $i++) : ?>
                <div id="inputImage">
                    <div class="media mb-4">
                        <div class="d-block my-auto col-sm-3 border-0" id="row">
                            <img src="/img/default.jpg" id="img" class="img-thumbnail col-sm-12 p-0 sebelum-preview<?= $i; ?> rounded" alt="Image<?= $i; ?>">
                        </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="custom-file col-sm-10 my-2">
                                    ...
                                    <div class="invalid-feedback">
                                        <?php $validation->getError('foto_sebelum'); ?>
                                    </div>
            ...
            <div class="form-group mb-5">
                ...
                <input type="text" required class="form-control rounded-sm <?= ($validation->hasError('tema')) ? 'is-invalid' : ''; ?>" id="tema" name="tema" placeholder="Tema One Point Lesson" value="<?= old('tema'); ?>" autofocus>
                <div class="invalid-feedback">
                    <?php $validation->getError('tema'); ?>
                </div>
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" id="jumlahFileFoto" name="jumlahFileFoto" value="<?= $inputFotoPD; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group mb-5">
                ...
                <div class="invalid-feedback">
                    <?php $validation->getError('tujuan'); ?>
                </div>
            ...
            <div class="form-group mb-5">
                ...
                <div class="invalid-feedback">
                    <?php $validation->getError('fungsi'); ?>
                </div>
            ...
            <div class="form-group mb-5">
                ...
                <div class="invalid-feedback">
                    <?php $validation->getError('penjelasan'); ?>
                </div>
            ...
            <div class="form-group mb-5">
                ...
                <div class="invalid-feedback">
                    <?php $validation->getError('dampak'); ?>
                </div>
