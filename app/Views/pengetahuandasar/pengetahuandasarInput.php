            ...
            <div class="form-group row">
                <div class="form-row col-sm-12 px-0">
                    ...
                    <div class="form-group col-sm-5">
                        <input type="number" min="0" max="8" class="form-control rounded-sm" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $inputFotoPD; ?>">
                    </div>
