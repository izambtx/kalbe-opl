                ...
                <table class="table table-bordered text-gray-900">
                    <tbody>
                        <tr>
                            ...
                            <td scope=" col" class=" align-middle"><small class="font-weight-bold" style="width: 10%;"><?= $pengetahuandasar['nama_mesin']; ?></small></td>
                        </tr>
                        <tr>
                            ...
                            <?php if ($pengetahuandasar['status'] == 'Created' || $pengetahuandasar['status'] == 'Returned Supervisor') : ?>
