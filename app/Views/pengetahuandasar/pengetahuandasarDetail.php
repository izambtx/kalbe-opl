                    ...
                    <tbody>
                        <tr>
                            ...
                            <td scope="col" rowspan="4">
                                ...
                                <br>
                                <?php if (in_groups('engineer') && $pengetahuandasar['id_distribusi'] == 1) : ?>
                                    <br>
                                    <br>
                                    <span class="h4 font-weight-bold">NA</span>
                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/PengetahuanDasar/approve/<?= $pengetahuandasar['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="OPL1-<?= $pengetahuandasar['singkatan']; ?>.<?= $countOPL; ?>.<?= $pengetahuandasar['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/PengetahuanDasar/check/<?= $pengetahuandasar['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="<?= $pengetahuandasar['nama_mesin']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    <label for="approveopl" class="col-sm-3 col-form-label">Approver </label>
