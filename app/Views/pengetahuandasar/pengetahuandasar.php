                        ...
                        <tbody class="text-gray-900">
                            ...
                            <?php foreach ($pengetahuandasar as $pd) : ?>
                                <?php if (in_groups('engineer')) : ?>
                                    <?php if ($pd['id_distribusi'] == '1' && $pd['status'] == 'Created' || $pd['status'] == 'Approved Supervisor' && $pd['realisasi'] == 'FALSE') : ?>
                                        <tr>
                                    ...
                                    <?php endif; ?>
                                <?php elseif (in_groups('supervisor')) : ?><tr>
                                        <td class="align-middle" scope="row"><?= $i++; ?></td>
                                        <td class="w-50 align-middle"><?= $pd['tema'];  ?></td>
                                        <td class="align-middle"><?= $pd['nama_distribusi'];  ?></td>
                                        <?php if ($pd['mesin'] == '1') : ?>
