                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <?php foreach ($realisasi as $r) : ?>
                                        <?php if ($r['id_pd'] == $pdU['id'] && $pdU['realisasi'] == 'TRUE') : ?>
                                            <span class="badge badge-primary">DONE</span>
                                        <?php elseif ($r['id_pd'] == $pdU['id'] && $pdU['realisasi'] == 'CLOSED') : ?>
                                ...
                                <td class="align-middle w-25">
                                    <?php foreach ($foto_pdU as $f) : ?>
                                        <?php if ($f['id_pd'] == $pdU['id']) : ?>
                                            <img src="/img/<?= $f['foto_pd']; ?>" style="aspect-ratio: 2/1; object-fit:fill;" class="img-thumbnail m-0 p-0 h-25" alt="Gambar OPL">
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                        ...
                        <tbody class="text-gray-900">
                            ...
                            <?php foreach ($pengetahuandasar as $pd) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle"><?= date('d M Y', strtotime($pd['updated_at'])); ?></td>
                                    <td class="align-middle">
                                        <a class="btn btn-sm rounded-circle" href="/ListPengetahuanDasar/DetailsUserPengetahuanDasar/<?= $pd['id']; ?>" role="button">
