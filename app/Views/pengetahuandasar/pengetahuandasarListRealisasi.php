                    ...
                    <tbody class="text-gray-900">
                        ...
                        <?php foreach ($pengetahuandasarUserMesin as $pdU) : ?>
                            <tr>
                                ...
                                <?php if ($pdU['mesin'] == 'Non Mesin') : ?>
                                    <td class="align-middle"><span class="badge badge-info"><?= $pdU['nama_mesin'];  ?></span></td>
                                <?php else : ?>
                                    <td class="align-middle"><span class="badge badge-primary"><?= $pdU['nama_mesin'];  ?></span></td>
                                <?php endif; ?>
