<?php if (in_groups('user') && $pengetahuandasar['pembuat'] == user_id()) : ?>
    ...
    <div class="container-fluid mb-5">
        ...
        <?php if (empty($inputFotoPD)) : ?>
            <?php $jumlahFoto = $countFotoPD + $inputFotoPD; ?>
        <?php else : ?>
            <?php $jumlahFoto = $countFotoPD + $inputFotoPD - $countFotoPD; ?>
        <?php endif; ?>

        <div class="card p-5">

            <div class="d-flex justify-content-between">
                <a href="<?= base_url('/ListPengetahuanDasar/DetailsUserPengetahuanDasar/' . $pengetahuandasar['id']); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Back to Detail</a>
                ...
                <div class="form-group row">
                    <div class="form-row col-sm-12 px-0">
                        ...
                        <div class="form-group col-sm-5">
                            <input type="number" disabled min="<?= $countFotoPD; ?>" max="15" autofocus class="form-control rounded-sm <?= ($validation->hasError('jumlahFoto')) ? 'is-invalid' : ''; ?>" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $jumlahFoto; ?>">
                        </div>
            ...
            <!-- Form Input -->
            <form action="/ListPengetahuanDasar/UpdatePengetahuanDasar/<?= $pengetahuandasar['id']; ?>" method="post" enctype="multipart/form-data">
                <?php csrf_field(); ?>

                <?php $i = 1; ?>
                <?php foreach ($fotoPD as $FPD) : ?>
                    <div id="inputImage">
                        <div class="media mb-4">
                            <div class="d-block my-auto col-sm-3 border-0" id="row">
                                <img src="/img/<?= $FPD['foto_pd']; ?>" id="img" class="img-thumbnail col-sm-12 p-0 sebelum-preview<?= $i; ?> rounded" alt="Gambar Pengetahuan Dasar">
                            </div>
                            <div class="media-body mx-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="custom-file col-sm-10 my-2">
                                        ...
                                        <label class="custom-file-label" id="label_sebelum<?= $i; ?>" name="label_sebelum<?= $i; ?>" for="foto_sebelum<?= $i; ?>"><?= $FPD['foto_pd']; ?></label>
                                    </div>
                                    <input type="hidden" value="<?= $FPD['foto_pd']; ?>" name="fotoLama<?= $i; ?>">
                                    <input type="hidden" value="<?= $FPD['id']; ?>" name="fotoID<?= $i; ?>">
                                </div>
                                <textarea class="form-control mt-2 rounded bg-light" rows="6" id="ket_foto<?= $i; ?>" placeholder="Keterangan Foto <?= $i; ?>" name="ket_foto<?= $i; ?>" value="<?= old('ket_foto'); ?>"><?= $FPD['keterangan']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <?php $i++; ?>
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control rounded-sm <?php if (session('validation.tema')) : ?>is-invalid<?php endif ?>" id="tema" name="tema" placeholder="Tema One Point Lesson" autofocus value="<?= $pengetahuandasar['tema']; ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    <input type="hidden" class="form-control" id="status" name="status" value="<?= $pengetahuandasar['status']; ?>">
                </div>
                <div class="form-group mb-5">
                    <input type="hidden" class="form-control" id="revisi" name="revisi" value="<?= $pengetahuandasar['revisi'] + 1; ?>">
                </div>
                <div class="form-group mb-5">
                    <label for="tujuan" class="text-gray-900 font-weight-bold">Tujuan</label>
                    <textarea class="<?php if (session('validation.tujuan')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="tujuan" placeholder="Keterangan Tujuan" name="tujuan" value="<?= $pengetahuandasar['tujuan']; ?>"><?= $pengetahuandasar['tujuan']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.fungsi')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="fungsi" placeholder="Keterangan Fungsi" name="fungsi" value="<?= $pengetahuandasar['fungsi']; ?>"><?= $pengetahuandasar['fungsi']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.penjelasan')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="penjelasan" placeholder="Keterangan Prosedur / Penjelasan" name="penjelasan" value="<?= $pengetahuandasar['penjelasan']; ?>"><?= $pengetahuandasar['penjelasan']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.dampak')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="dampak" placeholder="Keterangan Dampak Bila Tidak Dilakukan" name="dampak" value="<?= $pengetahuandasar['dampak']; ?>"><?= $pengetahuandasar['dampak']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control rounded-sm" id="sdwi" name="sdwi" placeholder="Masukan Nomor SD/WI" value="<?= $pengetahuandasar['sd/wi_no']; ?>" autofocus>
                </div>
                <div class="form-group mb-5">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" id="mesin" name="mesin">
                            ...
                            <?php foreach ($mesin as $m) : ?>
                                <option value="<?= $m['id'];  ?>" <?= $pengetahuandasar['mesin'] == $m['id'] ? 'selected' : null; ?>>
                                    <?= $m['nama_mesin'];  ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="<?php if (session('validation.department')) : ?>is-invalid<?php endif ?> custom-select" id="department" name="department">
                            ...
                            <?php foreach ($distribusi as $d) : ?>
                                <option value="<?= $d['id'];  ?>" <?= $pengetahuandasar['id_distribusi'] == $d['id'] ? 'selected' : null; ?>><?= $d['nama_distribusi'];  ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">
