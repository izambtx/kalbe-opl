    ...
    <div class="container-fluid mb-5">
        ...
        <div class="card p-5">
            ...
            <div class="d-flex justify-content-between">
                <a href="<?= base_url('/ListPengetahuanDasar/Status/' . user()->id); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Back to List</a>
            ...
            <form action="/ListPengetahuanDasar/UpdatePengetahuanDasar/<?= $pengetahuandasar['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" required class="form-control rounded-sm <?= ($validation->hasError('tema')) ? 'is-invalid' : ''; ?>" id="tema" name="tema" placeholder="Tema One Point Lesson" autofocus value="<?= $pengetahuandasar['tema']; ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="tujuan" placeholder="Keterangan Tujuan" name="tujuan" value="<?= $pengetahuandasar['tujuan']; ?>"><?= $pengetahuandasar['tujuan']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="fungsi" placeholder="Keterangan Fungsi" name="fungsi" value="<?= $pengetahuandasar['fungsi']; ?>"><?= $pengetahuandasar['fungsi']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="penjelasan" placeholder="Keterangan Prosedur / Penjelasan" name="penjelasan" value="<?= $pengetahuandasar['penjelasan']; ?>"><?= $pengetahuandasar['penjelasan']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="dampak" placeholder="Keterangan Dampak Bila Tidak Dilakukan" name="dampak" value="<?= $pengetahuandasar['dampak']; ?>"><?= $pengetahuandasar['dampak']; ?></textarea>
                </div>
                <div class="form-group mb-5">
