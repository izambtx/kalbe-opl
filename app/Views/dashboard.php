            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header rounded-lg bg-white border-bottom-0 py-4 d-flex flex-row align-items-center justify-content-between">
                    <?php if ($month && $year && $distribusi && $users) : ?>
                        <h6 class="font-weight-bold text-gray-900" style="max-width: 70%;">Laporan Grafik OPL <span class="text-success"><?= $usersNama['fullname']; ?></span> - <?= $distribusiNama['nama_distribusi']; ?>, <?= date("F", mktime(0, 0, 0, $month)); ?> <?= $year; ?></h6>
                    <?php else : ?>
