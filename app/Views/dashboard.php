...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="row">
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 pb-2">
                <div class="card-body pb-0 mb-0">
                    <div class="row no-gutters align-items-center">
                        <div class="col-sm-12">
                            <div class="text-xs font-weight-bold text-primary text-uppercase">
                                OPL Kategori Pengetahuan Dasar Terbanyak
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <table class="table table-borderless text-gray-900">
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($maxCPD1 as $count) : ?>
                                        <tr>
                                            <td class="align-middle p-0 pt-2">
                                                <b><?= $count['fullname']; ?><br>
                                                    <small><?= $count['nama_distribusi']; ?></small>
                                            </td>
                                            <td class="align-middle p-0 pt-2">
                                                <h5 class="text-center align-middle font-weight-bold"><?= $count['pembuat']; ?></h5>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 pb-2">
                <div class="card-body pb-0 mb-0">
                    <div class="row no-gutters align-items-center">
                        <div class="col-sm-12">
                            <div class="text-xs font-weight-bold text-success text-uppercase">
                                OPL Kategori Improvement Terbanyak
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <table class="table table-borderless text-gray-900">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 pb-2">
                <div class="card-body pb-0 mb-0">
                    <div class="row no-gutters align-items-center">
                        <div class="col-sm-12">
                            <div class="text-xs font-weight-bold text-info text-uppercase">
                                OPL Kategori Trouble Shooting Terbanyak
                            </div>
    ...
    <form action="" method="post" class="col-sm-12 bg-white pt-3 rounded-top ">
        <div class="row">
            <div class="input-group col-sm-6 pl-1 ml-2 p-0">
                <select class="custom-select text-gray-900 font-weight-bold rounded-sm" id="filter" name="filter">
                    ...
                    <!-- <option value="7"><?= date('F', mktime(0, 0, 0, 11)); ?></option> -->
                </select>
    ...
    <div class="d-flex justify-content-center pb-3">
        <form action="" method="post" class="col-sm-12 form-inline bg-white pt-3 rounded-bottom">
            ...
            <?php elseif ($filter == 2) : ?>
                <div class="input-group mb-3 col-sm-3">
                    <select class="custom-select text-gray-900 font-weight-bold rounded-sm" id="oplNoPD" name="oplNoPD">
                        ...
                        <?php foreach ($oplNoPDList as $OPD) : ?>
                ...
                <div class="input-group mb-3 col-sm-2">
                    <select class="custom-select text-gray-900 font-weight-bold rounded-sm" id="oplNoIM" name="oplNoIM">
                        ...
                        <?php foreach ($oplNoIMList as $OIM) : ?>
                ...
                <div class="input-group mb-3 col-sm-3">
                    <select class="custom-select text-gray-900 font-weight-bold rounded-sm" id="oplNoTS" name="oplNoTS">
                        ...
                        <?php foreach ($oplNoTSList as $OTS) : ?>
            ...
            <?php if ($month && $year) : ?>
                ...
                <?php elseif ($oplNoPD || $oplNoIM || $oplNoTS) : ?>
                    <div class="input-group mb-3 col-sm-3">
                        <select class="custom-select text-gray-900 font-weight-bold rounded-sm" id="oplNoPD" name="oplNoPD">
                            <option selected disabled hidden>Pengetahuan Dasar</option>
                            <?php foreach ($oplNoPDList as $OPD) : ?>
                ...
                <div class="ml-4 mb-3">
                    ...
                    <div class="form-inline border border-success ml-2 pl-2 rounded">
                        <div class="input-group my-2 bg-light text-success text-center font-weight-bold form-control rounded-sm border border-abu">
                        ...
                        <?php else : ?>
                            <div class="input-group my-2 mr-2 bg-light text-success text-center font-weight-bold form-control rounded-sm border border-abu">
                                <span class="mt-1 align-middle">
                                    <i class="fas fa-tags mr-2"></i><?= $mesinNama['nama_mesin']; ?><i class="fas fa-times pl-2" style="cursor: pointer;"></i>
                                </span>
                            </div>
                        <?php endif; ?>
                        <?php if (empty($oplNoPD)) : ?>
                        <?php else : ?>
                            <div class="input-group my-2 mr-2 bg-light text-success text-center font-weight-bold form-control rounded-sm border border-abu">
                                <span class="mt-1 align-middle">
                                    <i class="fas fa-tags mr-2"></i><?= $oplNoPDNama['opl_no']; ?><i class="fas fa-times pl-2" style="cursor: pointer;"></i>
                                </span>
                            </div>
                        <?php endif; ?>
                        <?php if (empty($oplNoIM)) : ?>
                        <?php else : ?>
                            <div class="input-group my-2 mr-2 bg-light text-success text-center font-weight-bold form-control rounded-sm border border-abu">
                                <span class="mt-1 align-middle">
                                    <i class="fas fa-tags mr-2"></i><?= $oplNoIMNama['opl_no']; ?><i class="fas fa-times pl-2" style="cursor: pointer;"></i>
                                </span>
                            </div>
                        <?php endif; ?>
                        <?php if (empty($oplNoTS)) : ?>
                        <?php else : ?>
                            <div class="input-group my-2 mr-2 bg-light text-success text-center font-weight-bold form-control rounded-sm border border-abu">
                                <span class="mt-1 align-middle">
                                    <i class="fas fa-tags mr-2"></i><?= $oplNoTSNama['opl_no']; ?><i class="fas fa-times pl-2" style="cursor: pointer;"></i>
                                </span>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header rounded-lg bg-white border-bottom-0 py-4 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        $mesin = $request->getVar('mesin');
                        $users = $request->getVar('users');
                        $month = $request->getVar('month');
                        $year = $request->getVar('year');
                        $oplNoPD = $request->getVar('oplNoPD');
                        $oplNoIM = $request->getVar('oplNoIM');
                        $oplNoTS = $request->getVar('oplNoTS');
                        ...
                        if ($month && $year && $users) {
                            ...
                            if (empty($mesin) && $users) {
                                ...
                                $param = "?month=" . $month . "&year=" . $year . "&mesin=" . $mesin . "&users=" . $users;
                            }
                            ...
                            if (empty($mesin) && $distribusi) {
                                ...
                                $param = "?month=" . $month . "&year=" . $year . "&distribusi=" . $distribusi . "&mesin=" . $mesin;
                            }
                        } elseif ($month && $year && $mesin) {

                            $param = "?month=" . $month . "&year=" . $year . "&mesin=" . $mesin;
                        } elseif ($month && $year || $oplNoPD || $oplNoIM || $oplNoTS) {

                            $param = "?month=" . $month . "&year=" . $year . "&oplNoPD=" . $oplNoPD . "&oplNoIM=" . $oplNoIM . "&oplNoTS=" . $oplNoTS;
                        }
                        ?>
