        ...
        <div class="row">
            ...
            <div class="card text-center shadow mx-auto table-responsive">
                            ...
                            <tr>
                                ...
                                <td scope="col" class="align-middle border-left-0">
                                    <?php if ($improvementUser['status'] == 'Returned Supervisor' || $improvementUser['status'] == 'Returned Engineer') : ?>
                                        <a href="/ListImprovement/Edit/DetailsUserImprovement/<?= $improvementUser['id']; ?>" class="btn btn-warning font-weight-bold">UPDATE</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </tfoot>
                ...
                <div class="container my-5">
                    ...
                    <div class="row p-3 mt-3">
                        <table class="table table-bordered text-gray-900">
                            <tbody>
                                <tr id="noHover">
                                    <th scope="col" style="width: 25%;"><small class="font-weight-bold">Tujuan :</small></th>
                                    <th scope="col"><small class="font-weight-bold">Cara Mengatasi :</small></th>
                                    <th scope="col"><small class="font-weight-bold">Fungsi Part :</small></th>
                                    <th scope="col" style="width: 25%;"><small class="font-weight-bold">Dampak :</small></th>
                                </tr>
                                <tr class="text-left">
                ...
                <div class="container">
                    ...
                    <?php if ($improvementUser['realisasi'] == 'TRUE' && $improvementUser['pembuat'] == user_id()) : ?>
                        <div class="row p-3">
                                            ...
                                            <?php if (empty($rim['id_trainer'])) : ?>
                                                ...
                                                <td class="align-middle" scope="row">
                                                    <form class="d-inline" action="/ListImprovement/DetailsUserImprovement/ParafTrainer/<?= $improvementUser['id']; ?>" method="post">
                                                        <input type="text" name="id" id="id" value="<?= $rim['id']; ?>">
