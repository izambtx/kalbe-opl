    ...
    <div class="container-fluid mb-5">
        ...
        <div class="card p-5">
            ...
            <div class="d-flex justify-content-between">
                <a href="<?= base_url('/ListImprovement/DetailsUserImprovement/' . $improvement['id']); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Back to Detail</a>
            ...
            <form action="/ListImprovement/UpdateImprovement/<?= $improvement['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control rounded-sm <?php if (session('validation.tema')) : ?>is-invalid<?php endif ?>" id="tema" name="tema" placeholder="Tema One Point Lesson" autofocus value="<?= $improvement['tema']; ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.tujuan')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="tujuan" placeholder="Keterangan Tujuan" name="tujuan" value="<?= $improvement['tujuan']; ?>"><?= $improvement['tujuan']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.fungsi')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="fungsi" placeholder="Keterangan Fungsi" name="fungsi" value="<?= $improvement['fungsi']; ?>"><?= $improvement['fungsi']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.penjelasan')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="penjelasan" placeholder="Keterangan Prosedur / Penjelasan" name="penjelasan" value="<?= $improvement['penjelasan']; ?>"><?= $improvement['penjelasan']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="<?php if (session('validation.dampak')) : ?>is-invalid<?php endif ?> form-control rounded" rows="5" id="dampak" placeholder="Keterangan Dampak Bila Tidak Dilakukan" name="dampak" value="<?= $improvement['dampak']; ?>"><?= $improvement['dampak']; ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control rounded-sm" id="sdwi" name="sdwi" placeholder="Masukan Nomor SD/WI" value="<?= $improvement['sd/wi_no']; ?>" autofocus>
                </div>
                <div class="form-group mb-5">
