                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/Improvement/approve/<?= $improvement['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="OPL2-<?= $improvement['singkatan']; ?>.<?= $countOPL; ?>.<?= $improvement['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
