                ...
                <table class="table table-bordered text-gray-900">
                    <tbody>
                        <tr>
                                ...
                                <?php if (in_groups('engineer')) : ?>
                                    <?php if (empty($improvement['checked_at']) || empty($improvement['engineer'])) : ?>
                                        ...
                                        <?php elseif ($improvement['status'] == 'Returned Engineer') : ?>
                                            <br>
                                            <span class="badge badge-warning p-2 font-weight-bold rotate-n-15 mt-3 mb-3">RETURNED</span>
                                        <?php elseif ($improvement['id_distribusi'] != 1) : ?>
                                            <button type="button" class="btn btn-warning btn-sm btn-block mt-2" data-toggle="modal" data-target="#returnModal">Return</button>
                                            <button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <button type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#approveModal">Approve</button>
                                        <?php elseif (in_groups('engineer') && $improvement['id_distribusi'] == 1 && empty($improvement['checked_at']) || empty($improvement['engineer'])) : ?>
                                            <button type="button" class="btn btn-warning btn-sm btn-block mt-2" data-toggle="modal" data-target="#returnModal">Return</button>
                                            <button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <button type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#approveModal">Approve</button>
                                        <?php else : ?>
                            ...
                            <td scope=" col" class=" align-middle"><small class="font-weight-bold" style="width: 10%;"><?= $improvement['sd/wi_no']; ?></small></td>
                        </tr>
                        <tr>
                            ...
                            <?php if ($improvement['status'] == 'Created' || $improvement['status'] == 'Updated' || $improvement['status'] == 'Returned Supervisor' || $improvement['status'] == 'Updated') : ?>
                            ...
                            <tbody>
                                ...
                                <?php else : ?>
                                    <tr id="noHover">
                                        ...
                                        <td scope="col" colspan="3"><small class="font-weight-bold"><?= $improvement['nama_mesin']; ?></small></td>
                                    </tr>
                                <?php endif; ?>
                                <tr id="noHover">
                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/Improvement/approve/<?= $improvement['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <?php if (empty($improvement['sd/wi_no'])) : ?>
                                            <input type="text" id="sdwi" name="sdwi" class="form-control rounded-sm" placeholder="Masukan SD/WI No. Jika Ada"></input>
                                        <?php else : ?>
                                            <input type="text" id="sdwi" name="sdwi" readonly class="form-control font-weight-bold text-gray-900 border-0 bg-white" value="<?= $improvement['sd/wi_no']; ?>"></input>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                ...
                                <?php else : ?>
                                    <?php if ($improvement['id_distribusi'] == '1') : ?>
                                        <input type="hidden" class="border-0 d-block" value="TRUE" id="statusrealisasi" name="statusrealisasi">
                                    <?php else : ?>
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/Improvement/check/<?= $improvement['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <p id="mesin" name="mesin" class="form-control font-weight-bold text-gray-900 border-0 bg-white"><?= $improvement['nama_mesin']; ?></p>
                                    </div>
                                </div>
                                <div class="form-group row mb-0 mt-2">
                                    <label for="noopl" class="col-sm-3 col-form-label">OPL No. </label>
                                    <div class="col-sm-9">
                                        <?php if ($improvement['approved_at'] || $improvement['penyetuju']) : ?>
                                            <input type="text" id="noopl" name="noopl" readonly value="<?= $improvement['opl_no']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                        <?php else : ?>
                                            <input type="text" id="noopl" name="noopl" readonly value="OPL1-<?= $improvement['singkatan']; ?>.<?= $pengetahuandasar['opl_no']; ?>.<?= $pengetahuandasar['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
