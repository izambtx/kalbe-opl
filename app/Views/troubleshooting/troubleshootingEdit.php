    ...
    <div class="container-fluid mb-5">
        ...
        <div class="card p-5">
            ...
            <div class="d-flex justify-content-between">
                <a href="<?= base_url('/ListTroubleShooting/Status/' . user()->id); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Back to List</a>
                ...
                <div class="form-group row">
                    <div class="form-row col-sm-12 px-0">
                        ...
                        <div class="form-group col-sm-5">
                            <input type="number" disabled min="<?= $countFotoTS; ?>" max="15" autofocus class="form-control rounded-sm <?= ($validation->hasError('jumlahFoto')) ? 'is-invalid' : ''; ?>" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $jumlahFoto; ?>">
                        </div>
            ...
            <form action="/ListTroubleShooting/UpdateTroubleShooting/<?= $troubleshooting['id']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="media-body mx-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="custom-file col-sm-10 my-2">
                                        <input type="file" accept="image/*" class="custom-file-input <?= ($validation->hasError('foto_sebelum')) ? 'is-invalid' : ''; ?>" id="foto_sebelum<?= $i; ?>" name="foto_sebelum<?= $i; ?>" value="<?= $FTS['foto_ts']; ?>" onchange="preview_sebelum<?= $i; ?>()">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" required class="form-control rounded-sm <?= ($validation->hasError('tema')) ? 'is-invalid' : ''; ?>" id="tema" name="tema" placeholder="Tema One Point Lesson" autofocus value="<?= $troubleshooting['tema']; ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="tujuan" placeholder="Keterangan Tujuan" name="tujuan" value="<?= $troubleshooting['tujuan']; ?>"><?= $troubleshooting['tujuan']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="fungsi" placeholder="Keterangan Fungsi" name="fungsi" value="<?= $troubleshooting['fungsi']; ?>"><?= $troubleshooting['fungsi']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="penjelasan" placeholder="Keterangan Prosedur / Penjelasan" name="penjelasan" value="<?= $troubleshooting['penjelasan']; ?>"><?= $troubleshooting['penjelasan']; ?></textarea>
                </div>
                <div class="form-group mb-5">
                    ...
                    <textarea class="form-control rounded" required rows="5" id="dampak" placeholder="Keterangan Dampak Bila Tidak Dilakukan" name="dampak" value="<?= $troubleshooting['dampak']; ?>"><?= $troubleshooting['dampak']; ?></textarea>
                </div>
                <div class="form-group mb-5">
