                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/TroubleShooting/approve/<?= $troubleshooting['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="OPL3-<?= $troubleshooting['singkatan']; ?>.<?= $countOPL; ?>.<?= $troubleshooting['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
