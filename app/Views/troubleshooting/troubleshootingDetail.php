<?php if ($troubleshooting['id_distribusi'] == user()->distribusi && in_groups('supervisor') || in_groups('engineer')) : ?>
            ...
            <div class="card text-center shadow mx-auto table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td scope="col" rowspan="4">
                                ...
                                <br>
                                <br>
                                <small class="font-weight-bold text-primary"><?= date('d M Y', strtotime($troubleshooting['created_at'])); ?></small>
                                <br>
                                <small class="font-weight-bold text-primary"><?= date('H : i : s', strtotime($troubleshooting['created_at'])); ?></small>
                                <br>
                                <br>
                                <span class="font-weight-bold text-gray-900"><?= $troubleshooting['username']; ?></span>
                            </td>
                            <td scope="col" rowspan="4">
                                ...
                                <?php if (in_groups('supervisor')) : ?>
                                    <?php if (empty($troubleshooting['penyetuju'])) : ?>
                                        <?php if ($troubleshooting['status'] == 'Rejected Supervisor') : ?>
                                            <br>
                                            <span class="badge badge-danger p-2 font-weight-bold rotate-n-15 mt-3 mb-3">REJECTED</span>
                                        <?php elseif ($troubleshooting['status'] == 'Returned Supervisor') : ?>
                                            <br>
                                    ...
                                    <?php else : ?>
                                        <br>
                                        <small class="font-weight-bold text-primary"><?= date('d M Y', strtotime($troubleshooting['approved_at'])); ?></small>
                                        <br>
                                        <small class="font-weight-bold text-primary"><?= date('H : i : s', strtotime($troubleshooting['approved_at'])); ?></small>
                                        <br>
                                        <br>
                                        <span class="font-weight-bold text-gray-900"><?= $troubleshooting2['username']; ?></span>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <?php if (empty($troubleshooting['penyetuju'])) : ?>
                                        <br>
                            ...
                            <td scope="col" rowspan="4">
                                ...
                                <?php if (in_groups('engineer')) : ?>
                                    <?php if (empty($troubleshooting['checked_at']) || empty($troubleshooting['engineer'])) : ?>
                                        <?php if ($troubleshooting['status'] == 'Rejected Engineer') : ?>
                                            <br>
                                            <span class="badge badge-danger p-2 font-weight-bold rotate-n-15 mt-3 mb-3">REJECTED</span>
                                        <?php elseif ($troubleshooting['status'] == 'Returned Engineer') : ?>
                                            <br>
                                            <span class="badge badge-warning p-2 font-weight-bold rotate-n-15 mt-3 mb-3">RETURNED</span>
                                        <?php elseif ($troubleshooting['id_distribusi'] != 1) : ?>
                                            <button type="button" class="btn btn-warning btn-sm btn-block mt-2" data-toggle="modal" data-target="#returnModal">Return</button>
                                            <button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <button type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#approveModal">Approve</button>
                                        <?php elseif (in_groups('engineer') && $troubleshooting['id_distribusi'] == 1 && empty($troubleshooting['checked_at']) || empty($troubleshooting['engineer'])) : ?>
                                            <button type="button" class="btn btn-warning btn-sm btn-block mt-2" data-toggle="modal" data-target="#returnModal">Return</button>
                                            <button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <button type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#approveModal">Approve</button>
                                        <?php else : ?>
                                    ...
                                    <?php else : ?>
                                        <br>
                                        <small class="font-weight-bold text-primary"><?= date('d M Y', strtotime($troubleshooting['checked_at'])); ?></small>
                                        <br>
                                        <small class="font-weight-bold text-primary"><?= date('H : i : s', strtotime($troubleshooting['checked_at'])); ?></small>
                                        <br>
                                        <br>
                                        <span class="font-weight-bold text-gray-900"><?= $troubleshooting3['username']; ?></span>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <?php if (empty($troubleshooting['checked_at']) || empty($troubleshooting['engineer'])) : ?>
                                        <br>
                            ...
                            <td scope=" col" class=" align-middle"><small class="font-weight-bold" style="width: 10%;"><?= $troubleshooting['sd/wi_no']; ?></small></td>
                        </tr>
                        <tr>
                            <td scope=" row" class="align-middle"><small class="font-weight-bold">Tema : <?= $troubleshooting['tema']; ?></small></td>
                            <td class="font-weight-bold align-middle" style="width: 10%;"><small class="font-weight-bold">OPL No.</small></td>
                            <?php if ($troubleshooting['status'] == 'Created' || $troubleshooting['status'] == 'Updated' || $troubleshooting['status'] == 'Returned Supervisor' || $troubleshooting['status'] == 'Updated') : ?>
                                <td class="font-weight-bold align-middle" style="width: 10%;"><small class="font-weight-bold">NA</small></td>
                            <?php else : ?>
                                <td class="font-weight-bold align-middle" style="width: 10%;"><small class="font-weight-bold"><?= $troubleshooting['opl_no']; ?></small></td>
                            <?php endif; ?>
                        </tr>
                        <tr>
                            <td scope="row">
                            ...
                            <td class="font-weight-bold"><small class="font-weight-bold"><?= date('d M Y', strtotime($troubleshooting['updated_at'])); ?></small></td>
                        </tr>
                    </tbody>
                    <?php if ($troubleshooting['status'] == 'Rejected Supervisor' || $troubleshooting['status'] == 'Returned Supervisor' || $troubleshooting['status'] == 'Rejected Engineer' || $troubleshooting['status'] == 'Returned Engineer') : ?>
                        <tfoot>
                            <tr>
                                ...
                                <td scope="col" colspan="6" class="align-middle">
                                    <span class="small font-weight-bold"><?= $troubleshooting['alasan']; ?></span>
                                </td>
                            </tr>
                        </tfoot>
                    <?php endif; ?>
                ...
                <div class="container my-5">
                    ...
                    <div class="row p-3 mt-3">
                        <table class="table table-bordered text-gray-900">
                            <tbody>
                                <?php if ($troubleshooting['mesin'] == '1') : ?>
                                <?php else : ?>
                                    <tr id="noHover">
                                        <td scope="col" colspan="1"><small class="font-weight-bold">Mesin :</small></td>
                                        <td scope="col" colspan="3"><small class="font-weight-bold"><?= $troubleshooting['nama_mesin']; ?></small></td>
                                    </tr>
                                <?php endif; ?>
                                <tr id="noHover">
                                ...
                                <tr class="text-left">
                                    <td><?= $troubleshooting['tujuan']; ?></td>
                                    <td scope="row"><?= $troubleshooting['penjelasan']; ?></td>
                                    <td><?= $troubleshooting['fungsi']; ?></td>
                                    <td><?= $troubleshooting['dampak']; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="container">
                    ...
                    <?php if ($troubleshooting['realisasi'] == 'TRUE' && $troubleshooting['pembuat'] == user_id()) : ?>
                        <div class="row p-3">
                            <table class="table table-hover table-bordered text-gray-900">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row" colspan="4"><?= $troubleshooting['nama_distribusi']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/TroubleShooting/returnSupervisor/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field(); ?>
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/TroubleShooting/returnEngineer/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group row mb-0 mt-5">
                                    <label for="alasanreturn" class="col-sm-4 col-form-label">Reason Return </label>
                                    <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/TroubleShooting/rejectSupervisor/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group row mb-0 mt-5">
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/TroubleShooting/rejectEngineer/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group row mb-0 mt-5">
                                    <label for="alasanreject" class="col-sm-4 col-form-label">Reason Reject </label>
                                    <div class="col-sm-8">
            ...
            <div class="modal-content mb-0">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <?php if (in_groups('supervisor')) : ?>
                            <form action="/TroubleShooting/approve/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field();  ?>
                                <div class="form-group row mb-0 mt-5">
                                    <label for="temaopl" class="col-sm-3 col-form-label">Tema OPL </label>
                                    <div class="col-sm-9">
                                        <textarea readonly rows="4" id="temaopl" name="temaopl" class="form-control font-weight-bold text-gray-900 border-0 bg-white"><?= $troubleshooting['tema']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    <label for="noopl" class="col-sm-3 col-form-label">OPL No. </label>
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="OPL3-<?= $troubleshooting['singkatan']; ?>.<?= $troubleshooting['opl_no']; ?>.<?= $troubleshooting['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <?php if (empty($troubleshooting['sd/wi_no'])) : ?>
                                            <input type="text" id="sdwi" name="sdwi" class="form-control rounded-sm" placeholder="Masukan SD/WI No. Jika Ada"></input>
                                        <?php else : ?>
                                            <input type="text" id="sdwi" name="sdwi" readonly class="form-control font-weight-bold text-gray-900 border-0 bg-white" value="<?= $troubleshooting['sd/wi_no']; ?>"></input>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php if ($troubleshooting['mesin'] == '1') : ?>
                                ...
                                <?php else : ?>
                                    <?php if ($troubleshooting['id_distribusi'] == '1') : ?>
                                        <input type="hidden" class="border-0 d-block" value="TRUE" id="statusrealisasi" name="statusrealisasi">
                                    <?php else : ?>
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/TroubleShooting/check/<?= $troubleshooting['id']; ?>" method="post">
                                <?= csrf_field();  ?>
                                <div class="form-group row mb-0 mt-5">
                                    <label for="temaopl" class="col-sm-3 col-form-label">Tema OPL </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <p id="mesin" name="mesin" class="form-control font-weight-bold text-gray-900 border-0 bg-white"><?= $troubleshooting['nama_mesin']; ?></p>
                                    </div>
                                </div>
                                <div class="form-group row mb-0 mt-2">
                                    <label for="noopl" class="col-sm-3 col-form-label">OPL No. </label>
                                    <div class="col-sm-9">
                                        <?php if ($troubleshooting['approved_at'] || $troubleshooting['penyetuju']) : ?>
                                            <input type="text" id="noopl" name="noopl" readonly value="<?= $troubleshooting['opl_no']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                        <?php else : ?>
                                            <input type="text" id="noopl" name="noopl" readonly value="OPL1-<?= $troubleshooting['singkatan']; ?>.<?= $pengetahuandasar['opl_no']; ?>.<?= $pengetahuandasar['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
