                    ...
                    <tbody>
                        <tr>
                            ...
                            <td scope="col" rowspan="4">
                                ...
                                <br>
                                <?php if (in_groups('engineer') && $troubleshooting['id_distribusi'] == 1) : ?>
                                    <br>
                                    <br>
                                    <span class="h4 font-weight-bold">NA</span>
                        ...
                        <?php elseif (in_groups('engineer')) : ?>
                            <form action="/TroubleShooting/check/<?= $troubleshooting['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="noopl" name="noopl" readonly value="<?= $troubleshooting['nama_mesin']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    <label for="approveopl" class="col-sm-3 col-form-label">Approver </label>
