                            ...
                            <form action="/TroubleShooting/check/<?= $troubleshooting['id']; ?>" method="post">
                                ...
                                <div class="form-group row mb-0 mt-2">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php else : ?>
                                            <input type="text" id="noopl" name="noopl" readonly value="OPL1-<?= $troubleshooting['singkatan']; ?>.<?= $troubleshooting['opl_no']; ?>.<?= $troubleshooting['revisi']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
