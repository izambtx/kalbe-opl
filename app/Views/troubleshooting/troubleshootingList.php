    ...
    <div class="container-fluid mb-5">
        ...
        <div class="row mb-4">
            <div class="col-auto mr-auto">
                <a href="/ListTroubleShooting/CreateTroubleShooting" type="button" class="btn btn-outline-primary"><i class="fas fa-plus-circle"> </i> Write New</a>
            </div>
            <div class="col-auto">
                <div class="col-auto">
                            ...
                            <?php foreach ($troubleshooting as $ts) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle p-0 m-0 border-left-0 border-right-0">
                                        <a class="btn btn-sm rounded-circle" href="/ListImprovement/DetailsUserImprovement/<?= $ts['id']; ?>" role="button">
                                            <script src="https://cdn.lordicon.com/ritcuqlt.js"></script>
                                            <lord-icon src="https://cdn.lordicon.com/mrjuyheh.json" trigger="hover" colors="outline:#121331,primary:#231e2d,secondary:#545454,tertiary:#ebe6ef" style="width:25px;height:25px">
                                            </lord-icon>
                                        </a>
