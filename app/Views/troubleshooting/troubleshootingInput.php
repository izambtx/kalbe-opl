    ...
    <div class="card p-5">
            ...
            <div class="form-group row">
                <div class="form-row col-sm-12 px-0">
                    ...
                    <div class="form-group col-sm-5">
                        <input type="number" min="0" max="15" class="form-control rounded-sm <?= ($validation->hasError('jumlahFoto')) ? 'is-invalid' : ''; ?>" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $inputFotoTS; ?>">
                    </div>
        ...
        <form action="/ListTroubleShooting/SaveTroubleShooting" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-5">
                ...
                <textarea required class="form-control rounded" rows="5" id="tujuan" placeholder="Keterangan Tujuan" name="tujuan"><?= old('tujuan'); ?></textarea>
            </div>
            <div class="form-group mb-5">
                <label for="fungsi" class=" text-gray-900 font-weight-bold">Fungsi</label>
                <textarea required class="form-control rounded" rows="5" id="fungsi" placeholder="Keterangan Fungsi" name="fungsi"><?= old('fungsi'); ?></textarea>
            </div>
            <div class="form-group mb-5">
                <label for="penjelasan" class=" text-gray-900 font-weight-bold">Prosedur / Penjelasan</label>
                <textarea required class="form-control rounded" rows="5" id="penjelasan" placeholder="Keterangan Prosedur / Penjelasan" name="penjelasan"><?= old('penjelasan'); ?></textarea>
            </div>
            <div class="form-group mb-5">
                <label for="dampak" class=" text-gray-900 font-weight-bold">Dampak Bila Tidak Dilakukan</label>
                <textarea required class="form-control rounded" rows="5" id="dampak" placeholder="Keterangan Dampak Bila Tidak Dilakukan" name="dampak"><?= old('dampak'); ?></textarea>
            </div>
            <div class="form-group mb-5">
            ...
            <!-- <div class="form-group mb-5">
                <label for="engineer" class=" text-gray-900 font-weight-bold">Daftar Engineer</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="mesin">Options</label>
                    </div>
                    <input list="browsers" class="form-control" name="browser" id="browser">
                    <datalist class="fo" id="browsers">
            ...
            <div class="form-group mb-5">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select" id="distribusi" name="distribusi" required>
            ...
            <div class="form-group row mt-5">
                <div class="col-row justify-content-end">
                    <button class="btn btn-success px-sm-5" name="submitted" type="submit">Send &nbsp;&nbsp;<i class="fas fa-paper-plane"></i></button>
