        ...
        <div class="row">
            ...
            <div class="card text-center shadow mx-auto table-responsive">
                    ...
                    <table class="table table-bordered text-gray-900">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if ($troubleshootingUser['status'] == 'Created' || $troubleshootingUser['status'] == 'Updated' || $troubleshootingUser['status'] == 'Returned Supervisor') : ?>
                ...
                <div class="container">
                    ...
                    <?php if ($troubleshootingUser['realisasi'] != 'FALSE' && $troubleshootingUser['pembuat'] == user_id()) : ?>
                        ...
                        <div class="col-auto d-flex mb-5">
                            ...
                            <?php if ($troubleshootingUser['realisasi'] == 'TRUE') : ?>
                                <div class="col-auto">
                                    <form action="/ListTroubleShooting/DetailsUserTroubleShooting/CloseSosialisasi/<?= $troubleshootingUser['id']; ?>" method="post">
                                        <?= csrf_field(); ?>
                            ...
                            <?php elseif ($troubleshootingUser['realisasi'] == 'CLOSED') : ?>
                                <div class="col-auto">
                                    <form action="/ListTroubleShooting/DetailsUserTroubleShooting/OpenSosialisasi/<?= $troubleshootingUser['id']; ?>" method="post">
                                        <?= csrf_field(); ?>
                    ...
                    <div class="row p-3">
                        <table class="table table-hover table-bordered text-gray-900">
                            <tbody>
                                ...
                                <?php $i = 1 + ($perPage * ($currentPage - 1)); ?>
                                <?php foreach ($realisasiTS as $rts)
                                    foreach ($realisasiTrainerTS as $rtst) : ?>
                                    <tr>
                                        <td class="align-middle" scope="row"><?= $i++; ?></td>
                                        <td class="align-middle" scope="row"><?= date('d M Y', strtotime($rts['tanggal_training'])); ?></td>
                                        <td class="align-middle" scope="row"><?= $rts['username']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rts['paraf_trainee']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rtst['username']; ?></td>
                                        <td class="align-middle" scope="row"><?= $rts['paraf_trainer']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr>
