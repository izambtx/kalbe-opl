...
$routes->post('/ListPengetahuanDasar/CreatePengetahuanDasar', 'PengetahuanDasar::create');
...
$routes->post('/ListImprovement/CreateImprovement', 'improvement::create');
...
$routes->post('/ListTroubleShooting/CreateTroubleShooting', 'troubleshooting::create');
